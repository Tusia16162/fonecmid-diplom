...
Необходимо зайти через Конфигуратор Сервис-Параметры-Запуск 1С Предприятия-Дополнительные-Запускать как менеджер тестирования-Применить затем начать отладку. Рограмма 1С откроется как менеджер тестирования. Во вкладке Сервис и настройки-Файл-Открыть-Выбрать файл Vanessa Automation
